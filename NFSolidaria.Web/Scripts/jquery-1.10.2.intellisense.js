...
intellisense.anCupomte(_object, {
  'add': function() {
    /// <signature>
...
intellisense.anCupomte(jQuery.Event.prototype, {
...
intellisense.anCupomte(jQuery.fn, {
  'add': function() {
    /// <signature>
