...
namespace Common.Infrastructure.ORM.Repositories
{
    ...
    {
        private static IEnumerable DynamicQuery_(this Database database, string storedProcedure, object parameters = null)
        {
            TypeBuilder builder = createTypeBuilder("Common.Infrastructure.ORM", "Common.Infrastructure.ORM.Repositories", "dynamic");
            ...
            using (System.Data.IDbCommand command = database.Connection.CreateCommand())
            {
                try
                {
                    ...
                    var arguments = Parameters.PrepareArguments(storedProcedure, parameters);
            ...
            var result = database.SqlQuery(resultType, storedProcedure, parameters);
            return result;
        }
